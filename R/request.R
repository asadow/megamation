...
#'
#' @description `mm_req()` creates a request using [httr2::request()] and does
#'   the following:
#'
...
#'   environment variables `MEGAMATION_KEY` and `MEGAMATION_URL` from your
#'   `.Renviron`.
...
#'
#' @param endpoint The API endpoint. For example, `"timecard"` for employee
#'   transactions, and `"workorder"` for work orders. All endpoints are listed
#'   at <https://apidocs.megamation.com/>.
