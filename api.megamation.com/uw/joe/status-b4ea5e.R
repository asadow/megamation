structure(list(method = "GET", url = "https://api.megamation.com/uw/joe/status?ALLFIELDS=1", 
    ...
    request = structure(list(url = "https://api.megamation.com/uw/joe/status?ALLFIELDS=1", 
        ...
        }, cache_path = "C:\\Users\\asadow\\AppData\\Local\\Temp\\RtmpU9e4rU", 
