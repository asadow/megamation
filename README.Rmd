...
A custom request can be performed using `httr2::req_perform()`. An API response is returned. As the body of the response is  unwieldy (it contains raw bytes of a list), the helper function `mm_resp_data()` returns the data.
