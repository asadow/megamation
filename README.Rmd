...
The body of the response will contain raw bytes. It can be parsed using `mm_parse()`. The parsed response is a list which includes the data. If you are only interested in the data, you can skip `mm_parse()` and simply use `mm_resp_data()`.
